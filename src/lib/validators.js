...
export const createLeadSchema = z.object({
  ...
  nextFollowUpDate: z.string().datetime({ offset: true }).optional().nullable().or(z.literal('')),
...
export const createDealSchema = z.object({
  ...
  closeDate: z.string().datetime({ offset: true }).optional().nullable().or(z.literal('')),
...
export const createTaskSchema = z.object({
  ...
  description: optionalString(2000),
  dueDate: z.string().datetime({ offset: true }).optional().nullable().or(z.literal('')),
